...
%
As a result, \eclingo{} input language is just a minor extension of the input language accepted by {\tt gringo}~\cite{gekaosscth09a}, the grounder used by \clingo. In this way, \eclingo{} programs can be constructed with three different types of statements: \emph{rules}, \emph{show} statements and \emph{constant} definitions.
